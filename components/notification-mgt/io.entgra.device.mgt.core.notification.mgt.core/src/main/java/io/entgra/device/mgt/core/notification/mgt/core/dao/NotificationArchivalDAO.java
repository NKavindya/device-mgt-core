...
public interface NotificationArchivalDAO {
     ...
     * @throws NotificationManagementException If a database error occurs during the move.
     */
     ...
     * @throws NotificationManagementException If a database error occurs during the move.
     */
    void moveUserActionsToArchive(List<Integer> notificationIds) throws NotificationManagementException;
     ...
     * @throws NotificationManagementException If a database error occurs during the deletion.
     */
    int deleteOldNotifications(Timestamp cutoffTimestamp, int tenantId) throws NotificationManagementException;
     ...
     * @throws NotificationManagementException If a database error occurs during the deletion.
     */
    int deleteOldUserActions(List<Integer> notificationIds) throws NotificationManagementException;
     ...
     * @throws NotificationManagementException if a database error occurs.
     */
