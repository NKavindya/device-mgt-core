...
public class SQLServerNotificationManagementDAOImpl implements NotificationManagementDAO {
    ...
    public List<UserNotificationAction> getNotificationActionsByUser(
        ...
        try {
            ...
            String msg = "Error fetching user actions from SQL Server DB for user: " + username;
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
        return actions;
    ...
    public void updateNotificationAction(List<Integer> notificationIds, String username, String actionType)
        ...
        try {
            ...
            String msg = "Error occurred while updating notification actions in SQL Server for user: " + username;
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
    }
    ...
    public int getNotificationActionsCountByUser(String username, String status)
        ...
        try (Connection connection = NotificationManagementDAOFactory.getConnection();
            ...
            throw new NotificationManagementException("SQL Server error counting user notifications", e);
        }
        return 0;
    }
    ...
    public int getUnreadNotificationCountForUser(String username) throws NotificationManagementException {
        ...
        try {
            ...
            throw new NotificationManagementException("SQL Server DAO: Error retrieving unread notification count for user: "
                    + username, e);
        } finally {
