...
public class PostgreNotificationManagementDAOImpl implements NotificationManagementDAO {
    ...
    public List<UserNotificationAction> getNotificationActionsByUser(
        ...
        try {
            ...
            String msg = "Error fetching user actions from PostgreSQL DB for user: " + username;
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
        return actions;
    ...
    public void archiveAllUserNotifications(String username) throws NotificationManagementException {
        ...
        try {
            ...
            String msg = "Error occurred while archiving all notifications for user (PostgreSQL): " + username;
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
    }
