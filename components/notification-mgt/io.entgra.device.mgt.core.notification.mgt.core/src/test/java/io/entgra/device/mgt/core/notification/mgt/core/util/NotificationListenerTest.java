...
public class NotificationListenerTest {
    ...
    public void testListenerReceivesNotification() {
        ...
        assertEquals(receivedUserLists.size(), 1);
        assertEquals(receivedUserLists.get(0), users);
    }

    @Test
    public void testListenerReceivesMultipleNotifications() {
        NotificationEventBroker.pushMessage("Message 1", Collections.singletonList("user1"));
        NotificationEventBroker.pushMessage("Message 2", Arrays.asList("user2", "user3"));
