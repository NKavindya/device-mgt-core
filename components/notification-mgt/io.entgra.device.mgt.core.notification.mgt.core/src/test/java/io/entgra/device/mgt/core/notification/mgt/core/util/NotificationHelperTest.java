...
public class NotificationHelperTest {
    ...
    @Mock private RealmService realmSvc;
    ...
    public void testExtractUsernames_FromUsersAndRoles() throws Exception {
        ...
        Mockito.when(realmSvc.getTenantUserRealm(1).getUserStoreManager()).thenReturn(userStoreManager);
        Mockito.when(userStoreManager.getUserListOfRole("roleA")).thenReturn(new String[]{"u3", "u2"});
