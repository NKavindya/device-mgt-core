...
//            tenantDao.deleteDeviceOrganizationByTenantId(tenantId);
    ...
    public void publishScopesToTenant(String tenantDomain) throws TenantMgtException {
        if (!MultitenantConstants.SUPER_TENANT_DOMAIN_NAME.equals(tenantDomain)) {
            APIApplicationServices apiApplicationServices = TenantMgtDataHolder.getInstance().getApiApplicationServices();
            ...
            try {
                ...
                String msg = "Error occurred while generating the API application for tenant: '" + tenantDomain + "'.";
                log.error(msg, e);
                throw new TenantMgtException(msg, e);
            }
